package com.ty.dagger.daggerdemo.mvp.widget.statuslayout;
...
public class MultiStateView extends FrameLayout {
    ...
    private void ensureLoadingView() {
        if (mLoadingView == null && mLoadingViewResId > -1) {
            ...
            if (mListener != null)
                mListener.onStateInflated(VIEW_STATE_LOADING, mLoadingView);
    ...
    private void ensureEmptyView() {
        if (mEmptyView == null && mEmptyViewResId > -1) {
            ...
            if (mListener != null)
                mListener.onStateInflated(VIEW_STATE_EMPTY, mEmptyView);
    ...
    private void ensureErrorView() {
        if (mErrorView == null && mErrorViewResId > -1) {
            ...
            if (mListener != null)
                mListener.onStateInflated(VIEW_STATE_ERROR, mErrorView);
